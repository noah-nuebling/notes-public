...
Core:
    Mac Mouse Fix.xcloc
        ...
        Prep/Other:
        - If **new UI added** 
            – [x] Consider updating `testTakeScreenshots_Localization()` to cover new UI before running `./run uploadstrings`
...
Review: 
    Updated things:
        ...
        - [ ] Markdown docs (Readme.md etc.)    (See: https://github.com/noah-nuebling/mac-mouse-fix/tree/master/Markdown/LocalizedDocuments/xxx)
